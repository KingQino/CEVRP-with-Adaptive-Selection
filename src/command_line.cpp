...
LocalSearchPolicy parse_local_search_policy(const std::string& value) {
    ...
    if (normalized == "non_contextual"
        ...
        || normalized == "online-non-contextual") {
        return LocalSearchPolicy::OnlineNonContextual;
    }
...
void CommandLine::display_help() {
    std::cout
        ...
        << "  -gamma <double>                Follower trigger ratio (default: 1.05)\n"
